...
const HeroSection = () => {
    ...
    return (
        <header className="relative min-h-screen bg-black overflow-hidden" id="home">
                ...
                <div className="w-full max-w-7xl mx-auto">
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
                        ...
                        >
                            ...
                            <h2 className="text-blue-500 text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold mb-6 sm:mb-8 min-h-[3rem] sm:min-h-[4rem] lg:min-h-[5rem]">
                                <Typewriter
                            ...
                            <div className="text-gray-300 text-sm sm:text-base lg:text-lg leading-relaxed mb-6 sm:mb-8 space-y-2 max-w-2xl mx-auto lg:mx-0">
                                <p>
                                    A dedicated <span className="text-blue-500 font-semibold">developer</span>{' '}
                                    pursuing expertise in web development, full-stack systems, and embedded solutions
                                    as a Computer Science and Engineering undergraduate at Amrita Vishwa Vidyapeetham.
                                </p>
                                <p>
                                    Specializing in{' '}
                                    <span className="text-blue-500 font-semibold">modern web technologies</span> like
                                    ReactJS and Node.js, and{' '}
                                    <span className="text-blue-500 font-semibold">AI/ML solutions</span> with projects
                                    in AI Mock Interview and performance monitoring.
                                </p>
                                <p className="hidden sm:block">
                                    When not coding, I enjoy analyzing the thrills of{' '}
                                    <span className="text-blue-500 font-semibold">Formula 1</span> racing, blending my
                                    tech skills with a passion for motorsport data.
                                </p>
                            </div>

                            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
                                <a href="/myResume.pdf" download="pavan_vignesh_resume.pdf">
                                    <button className="bg-blue-500 text-white px-6 sm:px-8 py-3 rounded-full font-semibold hover:bg-blue-600 transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center justify-center gap-2 text-sm sm:text-base">
                                        My Resume
                                        <svg
                        ...
                        >
                            <div className="relative">
                                ...
                                <div
                                    className={`hidden md:flex gap-4 text-xl text-white mt-4 justify-center transition-all duration-700 delay-500 ${
                                ...
                                >
                                    ...
                                    <a
                                        href="https://www.linkedin.com/in/pavan-vignesh-75a171297"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        aria-label="LinkedIn"
                                        title="LinkedIn"
            ...
            <button
                className={`fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 w-12 h-12 sm:w-14 sm:h-14 bg-blue-500 rounded-full flex items-center justify-center text-white hover:bg-blue-600 transition-all duration-300 shadow-lg ${
                    isLoaded ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0'
                }`}
            >
