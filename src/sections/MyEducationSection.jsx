            ...
            <div className="max-w-7xl mx-auto w-full h-full flex flex-col">
                        ...
                        {educationData.map((item, index) => (
                            ...
                            >
                                <div className="bg-gray-900/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-800 transition-all duration-300 group relative overflow-hidden h-full">
                                    ...
                                    <div className="absolute inset-x-0 bottom-0 h-0 group-hover:h-[30%] bg-gradient-to-t from-green-500/40 via-emerald-500/20 to-transparent rounded-2xl transition-all duration-600 ease-in-out origin-bottom"></div>
                                    <div className="absolute inset-x-0 bottom-0 h-0 group-hover:h-[20%] bg-gradient-to-t from-green-500/20 via-emerald-500/10 to-transparent rounded-2xl transition-all duration-800 ease-in-out origin-bottom delay-100"></div>
                                    ...
                                    <div className="relative z-10">
                                        ...
                                        {/* Degree Title */}
                                        <h2 className="text-2xl font-bold text-white mb-2 group-hover:text-green-100 transition-colors">
                                            {item.degree}
                                        </h2>
                                        ...
                                        <div className="flex items-center gap-2 mb-3">
                                            ...
                                            <span className="text-green-400 font-medium text-sm">{item.type}</span>
                                        </div>

                                        {/* Score */}
                                        <div className="bg-gray-800/50 rounded-lg p-3 mb-3 border border-gray-700 group-hover:border-green-500/50 transition-colors">
                                            <div className="flex justify-between items-center">
                                                <span className="text-gray-300 text-sm">Score:</span>
                                                <span className="text-xl font-bold text-green-400">{item.score}</span>
                                            </div>
                                        ...
                                        {/* Achievement */}
                                        {item.achievement && (
                                            <div className="bg-yellow-900/20 rounded-lg p-3 mb-3 border border-yellow-800/50 group-hover:border-green-500/30 transition-colors">
                                        ...
                                        <div className="w-full bg-gray-700 rounded-full h-2 overflow-hidden">
                                            <div
                                                className={`h-full bg-gradient-to-r from-green-500 to-emerald-500 transition-all duration-1000 delay-${index * 300 + 500} ${
                ...
                <div className="grid grid-cols-4 gap-4 mt-8 flex-shrink-0">
                    ...
                    <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl p-4 border border-gray-800 group relative overflow-hidden text-center">
                        ...
                        <div className="absolute inset-x-0 bottom-0 h-0 group-hover:h-[20%] bg-gradient-to-t from-green-500/20 via-emerald-500/10 to-transparent rounded-xl transition-all duration-800 ease-in-out origin-bottom delay-100"></div>
                        <div className="relative z-10">
                            <div className="text-3xl font-bold text-green-500 mb-2 group-hover:scale-110 transition-transform">CSE</div>
